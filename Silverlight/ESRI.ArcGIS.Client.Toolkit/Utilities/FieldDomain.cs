...
namespace ESRI.ArcGIS.Client.Toolkit.Utilities
{
  ...
  /// </summary>
		...
		[Obsolete("Use the DisplayName property.")]
		public string Name
		{
	...
	public sealed class DynamicCodedValueSource : Dictionary<object, CodedValueSources>
	{
		...
		internal static CodedValueSources GetCodedValueSources(string lookupField,Field field, object generic, DynamicCodedValueSource dynamicCodedValueSource)
		{
			if (dynamicCodedValueSource != null && generic != null && !string.IsNullOrEmpty(lookupField))
			{
				...
				if (key == null)
				{
					...
					CodedValueSources nullableSources = new CodedValueSources();					
					if (field.Nullable)
					{																		
	...
	public sealed class DynamicCodedValueSourceLookupConverter : IValueConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
		{
			...
			DynamicCodedValueSource dynamicCodedValueSource = parameter as DynamicCodedValueSource;
			return DynamicCodedValueSource.GetCodedValueSources(LookupField,Field, value, dynamicCodedValueSource);						
		}
