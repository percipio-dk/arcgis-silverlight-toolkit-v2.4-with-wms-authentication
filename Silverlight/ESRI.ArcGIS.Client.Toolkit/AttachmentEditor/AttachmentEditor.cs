...
namespace ESRI.ArcGIS.Client.Toolkit
{
        ...
        /// <see cref="ESRI.ArcGIS.Client.FeatureLayer">FeatureLayer</see> of a backend ArcGIS Server <b>FeatureServer</b> 
    ...
    public class AttachmentEditor : Control
    {
        ...
        private void UpdateStates()
        {
            if (this._addNewButton != null)
            {
                ...
                {
                    this._addNewButton.IsEnabled = this.FeatureLayer.LayerInfo.HasAttachments;
                }
                else
