...
namespace ESRI.ArcGIS.Client.Toolkit.DataSources
{
	...
	/// </summary>
	public class WmsLayer : DynamicMapServiceLayer, ILegendSupport, ISublayerVisibilitySupport
	{
		...
		/// </summary>
		public IList<LayerInfo> LayerList { get; private set; }
		...
		/// <param name="ns">The nanespace name.</param>
		/// <returns></returns>
		private IList<WmsLayer.LayerInfo> CreateLayerInfos(XElement layers, string ns)
		{
			if (layers == null)
				return null;
