...
namespace ESRI.ArcGIS.Client.Toolkit.DataSources
{
	...
	/// <remarks>
	/// <para>
	/// Enhanced functionality to support more KML elements was added in the ArcGIS Silverlight/WPF/Windows Phone API's at 
	/// version 2.3. This brings the KML level of functionality very close to that of the KML specification used in 
	...
	/// As of version 2.3 of the API's, the following KML elements are parsed into the ArcGIS Layer types of:
	/// </para>
	/// <list type="table">
	...
	/// via the <see cref="ESRI.ArcGIS.Client.GroupLayer.ChildLayers">KmlLayer.ChildLayers</see> Property. See the code 
	...
	/// </para>
	/// <para><big>Windows Phone specific issues</big></para>
	/// <list type="bullet">
	/// <item>
	/// The <b>KmlLayer.MapTip</b> Property is only works in the Silverlight and WPF API’s; it is not supported in the 
	/// Windows Phone API.
	/// </item>
	/// <item>
	/// <b>TIP:</b> For Windows Phone applications, when using a Legend Control buddied with a Map Control that contains a 
	/// KmlLayer, use the <see cref="M:ESRI.ArcGIS.Client.Toolkit.Legend.LayerItemsMode">Legend.LayerItemsMode</see> = "Flat" 
	/// in order to see the graphical symbols in the Legend. This is not a KmlLayer specific issue, rather a function of 
	/// the default Legend template not taking advantage of the TreeView Control hierarchy for GroupLayers.
	/// </item>
	/// </list>
	/// <para><big>WPF specific issues</big></para>
	/// <list type="bullet">
	/// <item>
	/// There is a known issue of KmlLayer symbols briefly flickering in the upper left corner of the Windows Desktop when 
	/// a WPF application starts and stops.
	/// </item>
	/// </list>
	...
	/// development machine have several options depending on the API platform that they are developing on.
	/// </para>
	/// <para>
	/// <b><u>In Silverlight:</u></b>
	/// </para>
	/// <para>
	/// <b>Option #1:</b> Developers can place the KML/KMZ file in the ClientBin directory of the test web site that is 
	/// generated when creating a Silverlight application using Visual Studios built in web server (i.e. the directory that 
	/// has the  path: ..\[APPLICATION_NAME].Web\ClientBin). This option is the easiest method for testing KML/KMZ files when 
	/// there  is no web browser security issues because all of the KML/KMZ functionality is self contained. See the code 
	/// example in the <see cref="ESRI.ArcGIS.Client.Toolkit.DataSources.KmlLayer.Url">KmlLayer.Url</see> Property
	...
	/// </para>
	/// <para>
	/// <b>Option #1:</b> Because WPF does not have the same security restrictions as Silverlight, developers can place a 
	/// KML/KMZ file anywhere on the local hard drive and provide the file path as the KmlLayer.Url (example: 
	/// Url="C:\TEST_KML_FILES\Test.kml").
	/// </para>
	/// <para>
	/// <b>Option #2:</b> If developers want to use a local web server (like IIS) to place their KML/KMZ files for testing, 
	/// they are free to do so just like in Silverlight (example: Url="http://localhost/TEST_KML_FILES/Test.kml"). <b>NOTE:</b> 
	/// WPF does not use proxies so the use of KmlLayer.ProxyUrl is not necessary (even though the local KML file may have 
	/// resource links (i.e. http://) to locations outside of the local network).
	/// </para>
	/// <para>
	/// <b><u>In Windows Phone:</u></b>
	/// </para>
	/// <para>
	/// <b>Option #1:</b> If developers want to use a local web server (like IIS) to place their KML/KMZ files for testing, they 
	/// are free to do so just like in Silverlight (example: Url="http://localhost/TEST_KML_FILES/Test.kml").  <b>NOTE:</b> Windows 
	/// Phone does not use proxies so the use of KmlLayer.ProxyUrl is not necessary (even though the local KML file may have 
	/// resource links (i.e. http://) to locations outside of the local network).
	/// </para>  
	...
	/// </para>
	/// <para>
	/// <img border="0" alt="Adding KmlLayers to the Map using XAML and code-behind." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.KmlLayer.png"/>
	/// </para>
	...
	public class KmlLayer : GroupLayer
	{
		...
		/// <img border="0" alt="Choosing a Silverlight Application in Visual Studio." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.Url.VS_KML_Test_1.png"/>
		/// </item>
		/// <item>
		...
		/// <img border="0" alt="Accepting the defaults in the New Silverlight Application dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.Url.VS_KML_Test_2.png"/>
		/// </item>
		...
		/// <img border="0" alt="Location of the .kml file on disk." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.Url.VS_KML_Test_4.png"/>
		/// </item>
		/// <item>
		...
		/// Francisco):<br/>
		/// <img border="0" alt="Displaying the KML in a Map Control." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.Url.VS_KML_Test_3.png"/>
		/// </item>
		/// </list>
		/// </example>		
		...
		///  <img border="0" alt="Finding and opening the InetMgr.exe application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_1.png"/><br/>
		///  <img border="0" alt="The Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_2.png"/>
		///  </item>
		///  <item>
		...
		///  <img border="0" alt="Add a MIME Type in the Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_3.png"/>
		///  </item>
		///  <item>
		///  Click the <b>Add...</b> hyperlink to launch the <b>Add MIME Type</b> dialog (see the following screen shot):<br/>
		///  <img border="0" alt="The Add MIME Type dialog in the Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_4.png"/>
		///  </item>
		///  <item>
		...
		///  <img border="0" alt="The Internet Information Services (IIS) Manager application after the KML/KMZ MIME Types are added." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_5.png"/>
		///  </item>
		...
		///  <img border="0" alt="Destination Folder Access Denied dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_7.png"/><br/>
		///  <img border="0" alt="The Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_8.png"/><br/>
		...
		///   <img border="0" alt="Using Windows Explorer to see where the SLProxyPage.zip was unzipped." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_9.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Accessing the Properties of the proxy.config file in Using Windows Explorer." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_17.png"/>
		///   </item>
		///   <item>
		///   In the <b>proxy.config Properties</b> dialog, uncheck the <b>Read-only</b> attribute and click <b>Apply</b> (see the 
		///   following screen shot):<br/>
		///   <img border="0" alt="Removed the Read-only Attribute from the proxy.config file." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_27.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Using Windows Explorer to open the proxy.config file in Notepad." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_15.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Using Windows Explorer to open the proxy.config file in Notepad." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_16.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Destination Folder Access Denied dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_7.png"/><br/>
		///   <img border="0" alt="Confirming that the SLPRoxyPage directory was added to the C:\inetpub\wwwroot directoryin Windows Explorer." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_10.png"/>
		///   </item>
		///   <item>
		///   Type <b>InteMgr.exe</b> in the Windows 7 <b>Search programs and files taskbar</b> and hit Enter to launch the
		///   <b>Internet Information Service (IIS) Manager</b> application (see the following screen shots):<br/>
		///   <img border="0" alt="Starting the InetMgr.exe application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_1.png"/><br/>
		///   <img border="0" alt="Viewing the SLProxyPage folder in the Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_11.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Using the Internet Information Services (IIS) Manager application to convert the SLProxyPage folder into an Application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_12.png"/>
		///   </item>
		///   <item>
		///   In the <b>Add Application</b> dialog, accept the defaults and click <b>OK</b> (see the following screen shot):<br/>
		///   <img border="0" alt="Accept the defaults in the Add Application dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_13.png"/>
		///   </item>
		///   <item>
		///   This will change the icon for the <b>SLProxyPage</b> folder to be a web application in IIS (see the following screen shot):<br/>
		///   <img border="0" alt="Accept the defaults in the Add Application dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_14.png"/>
		///   </item>
		///   <item>
		...
		///   screen shot):<br/>
		///   <img border="0" alt="Confirming the C:\KML_TEST_FILES\Test_w_http_link.kml file exists in Windows Explorer." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_21.png"/>
		///   </item>
		///   <item>
		///   Copy the <b>C:\TEST_KML_FILES</b> directory to the <b>C:\inetpub\wwwroot</b> folder (see the following screen shot):<br/>
		///   <img border="0" alt="Using Windows Explorer to copy C:\TEST_KML_FILES to C:\inetpub\wwwroot." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_22.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Starting the InetMgr.exe application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_1.png"/><br/>
		///   <img border="0" alt="Viewing the KML_TEST_FILES folder in the Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_23.png"/>
		///   </item>
		///   <item>
		///   In the <b>Internet Information Services (IIS) Manager</b> application, right click on the <b>KML_TEST_FILES</b> folder and 
		///   choose <b>Convert to Application</b> (see the following screen shot):<br/>
		///   <img border="0" alt="Converting the KML_TEST_FILES folder into an Application in the Internet Information Services (IIS) Manager application." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_24.png"/>
		///   </item>
		///   <item>
		///   In the <b>Add Application</b> dialog, accept the defaults and click <b>OK</b> (see the following screen shot):<br/>
		///   <img border="0" alt="Accept the defaults in the Add Application dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_25.png"/>
		///   </item>
		///   <item>
		...
		///   <img border="0" alt="Accept the defaults in the Add Application dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_26.png"/>
		///   </item>
		///   <item>
		///   Close the <b>Internet Information Services (IIS) Manager</b> application.
		///   </item>
		...
		///   </list>
		///   See the following screen shot:<br/>
		///   <img border="0" alt="Choosing a Silverlight Application in Visual Studio." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_28.png"/>
		///   </item>
		///   <item>
		///   In the <b>New Silverlight Application</b> dialog, accept the defaults (make sure the <b>Host the Silverlight 
		///   application in a new Web site</b> is checked). This will use the Visual Studio built-in web server (Cassini) for 
		///   launching your Silverlight application (see the following screen shot):<br/>
		///   <img border="0" alt="Accepting the defaults in the New Silverlight Application dialog." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_29.png"/>
		///   </item>
		///   <item>Drag an ESRI Silverlight API <b>Map Control</b> onto the <b>MainPage.xaml</b> design surface.</item>
		///   <item>Add the following additional Reference to the Visual Studio Project: <b>ESRI.ArcGIS.Client.Toolkit.DataSources</b>.</item>
		///   <item>Replace the XAML code in the <b>MainPage.xaml</b> with the following:
		...
		///   <img border="0" alt="Displaying the KML in a Map Control." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.ProxyUrl.VS_KML_Test_20.png"/>
		///   </item>
		/// </list>
		/// </example>		
		...
		/// <remarks>
		/// <para>
		/// The KmlLayer.MapTip Property is only works in the ArcGIS for Silverlight and ArcGIS for WPF API’s; it is 
		/// not supported in the Windows Phone API. 
		/// </para>
		/// <para>
		...
		/// </para>
		/// <para>
		/// As of version 2.3 of the ArcGIS for Silverlight and ArcGIS for WPF API’s, the following KML tags map 
		...
		/// </para>
		/// <para>
		/// <img border="0" alt="Displaying a KmlLayer with MapTips in a Map Control." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.KmlLayer.MapTip2.png"/>
		/// </para>
		/// <para>
		...
		/// </list>
		/// See the following screen shot:<br/>
		/// <img border="0" alt="Choosing a Silverlight Application in Visual Studio." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.KmlLayer.MapTip1.png"/>
		/// </item>
		/// <item>
		/// In the <b>New Silverlight Application</b> dialog, accept the defaults (make sure the <b>Host the Silverlight 
		/// application in a new Web site</b> is checked). This will use the Visual Studio built-in web server (Cassini) for 
		...
		/// <img border="0" alt="Adding the ExtendedDataConverter Class to the Visual Studio Project." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.KmlLayer.MapTip1a.png"/>
		/// </item>
		/// <item>
		...
		/// (see the following screen shot):<br/>
		/// <img border="0" alt="Confirming the KML file has been created in the correct location." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.KmlLayer.MapTip1b.png"/>.
		/// </item>
		/// <item>
		/// Hit <b>F5</b> (or click the Start Debugging button) in Visual Studio to launch the Silverlight application in 
		...
		/// </para>
		/// <para>
		/// <img border="0" alt="Digging deep into the KmlLayer sub-layers to get detailed information like: geometry, symbology, and attributes." src="C:\ArcGIS\dotNET\API SDK\v2x-branch\ArcGISSilverlightSDK\LibraryReference\images\Client.Toolkit.DataSources.KmlLayer.Name.png"/>
		/// </para>
		/// <code title="Example XAML1" description="" lang="XAML">
		/// &lt;Grid x:Name="LayoutRoot"&gt;
		///   
			...
			set
			{
				if (_refreshInterval != value)
				{
					...
					if (_refreshInterval == TimeSpan.Zero)
						...
						StartRefreshTimer(_refreshInterval);
...
seekableStream
#else
							XmlReader.Create(seekableStream)
#endif
, LoadOptions.None);
		...
		private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
		{
			...
			KmlToFeatureDefinition ktg = new KmlToFeatureDefinition(ProxyUrl);

#if !SILVERLIGHT || WINDOWS_PHONE
			e.Result = ktg.Convert((KmlLayerContext)e.Argument, Credentials);
#else
			e.Result = ktg.Convert((KmlLayerContext)e.Argument);
#endif
		}

		private const double MaxNetworkLinkLevel = 3;
		...
		private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			...
			else
			{
				...
				if (fd.groundOverlays.Any())
				{
					...
					fd.CreateGroundOverlays(elementLayer, _context.Images);
				...
				foreach (ContainerInfo container in fd.containers)
				{
					...
					else
					{
						...
						try
						{
							kmlLayer.Url = new Uri(container.Url);
						}
						catch
						{
						...
						if (kmlLayer.Visible)
						{
							// Limit the number of NetworkLink level in order to avoid loading tons of images in the case of a KML tiled layer
							// This should be removed once the kml layer will manage the LOD and region tags
							int nbLevel = GetParents(this).Where(l => l._isRoot).Count();
							if (nbLevel > MaxNetworkLinkLevel)
		...
		private bool IsContainerVisible(string path, bool defaultVisibility)
		{
			...
			if (VisibleLayers.Contains(path))
				return true;
			...
			foreach (string filename in zipFile.EntryFileNames)
			{
				...
				switch (filename.Substring(lastPeriod).ToLower())
				{
					...
					case ".kml":
						...
						{
#if SILVERLIGHT
							XDocument doc = XDocument.Load(ms, LoadOptions.None);
							xDoc = doc;
#else
                            XDocument doc = XDocument.Load(XmlReader.Create(ms));
                            xDoc = doc;
#endif
						}
						catch { }
		...
		/// <summary>
		/// Start the timer to refresh the layer
		/// </summary>
		/// <param name="refreshInterval">Refresh interval.</param>
		private void StartRefreshTimer(TimeSpan refreshInterval)
		{
		...
		{
			int folderIDs = 0;
			foreach (var element in xContainer.Descendants().Where(HasId))
			{
				folderIDs++;
		...
		private static bool HasId(XElement element)
		{
			string name = element.Name.LocalName;
			// This list must be in sync with the kml servlet utility behavior
			return name == "BalloonStyle" || name == "LineStyle" || name == "Folder" || name == "Placemark" || name == "Document"
				|| name == "ScreenOverlay" || name == "GroundOverlay" || name == "NetworkLink" || name == "IconStyle" || name == "Icon" || name == "LookAt"
				|| name == "LineString" || name == "LinearRing";
		}
		...
		public override void QueryLegendInfos(Action<LayerLegendInfo> callback, Action<Exception> errorCallback)
		{
			if (callback != null)
			{
				if (IsInitialized)
				{
					...
					LayerLegendInfo layerLegendInfo = new LayerLegendInfo() { LegendItemInfos = null, LayerName = Name, LayerDescription = Name };
					...
					handler = delegate(object s, EventArgs e)
								{
									...
									// create one default layerLegendInfo item.
									LayerLegendInfo layerLegendInfo = new LayerLegendInfo() { LegendItemInfos = null, LayerName = kmlLayer.Name, LayerDescription = kmlLayer.Name };
									callback(layerLegendInfo);
								};
					Initialized += handler;
				}
